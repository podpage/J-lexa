...
import org.podpage.alexa.skills.alexa.response.PlainText;
import org.podpage.alexa.skills.alexa.response.Reprompt;
import org.podpage.alexa.skills.alexa.response.Response;
...
public class DemoSkill implements Skill {
    ...
    public SkillResponse call(Header inheader, AlexaRequest alexaRequest) {
        ...
        Response response = new Response(new PlainText("TEST"), reprompt);
